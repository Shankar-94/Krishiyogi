						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="full_name" class="form-control border border-dark" name="name" placeholder="Enter Your Name" pattern="[A-Za-z\s]+" required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="phone_number" class="form-control border border-dark" name="phonenumber" placeholder="Phone Number" maxlength="10" pattern="\d{10}" required>
									</div>
								</div>
								<div class="form-group row">
									<label for="farmid" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>Farmer Id</b></label>
									<div class="col-md-6">
										<input type="text" id="farmid" class="form-control border border-dark" name="farmid" placeholder="Farmer Id" pattern="[a-zA-Z0-9]+" required>
									</div>
								</div>
                                ...
                                <div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="account2" class="form-control border border-dark" name="pan" placeholder="Pan number" minlength="10" maxlength="10" pattern="[a-zA-Z0-9]+" required>
									</div>
								</div>
                                ...
                                <div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="account1" class="form-control border border-dark" name="account" placeholder="Bank Account number" maxlength="14" pattern="\d{14}"required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input id="p1" class="form-control border border-dark" type="password" name="password" placeholder="Password" minlength="8" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>
									</div>
								</div>
