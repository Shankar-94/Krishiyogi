...
<body>
    ...
    <div class="box">
        <form action="FarmerForgotPassword.php" method="post">
            ...
            <br>
            <input type="text"class="inp" name="phonenumber" placeholder="Phone Number" maxlength="10" pattern="\d{10}" required><br>
            <input type="text" class="inp" name="pan" placeholder="Pan Number" minlength="10" maxlength="10" pattern="[a-zA-Z0-9]+" required><br>

            <input type="password" class="inp" name="password" placeholder="Password" minlength="8" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required><br>
