						...
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="phone_number" class="form-control w-100 border border-dark" style="width:100% ! important;" name="phonenumber" placeholder="Phone Number" maxlength="10" pattern="\d{10}" required>
									</div>
								</div>
								...
								<div class="form-group row">
									<label for="account2" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>Aadhar Number</b></label>
									<div class="col-md-6">
										<input type="text" id="account2" class="form-control border border-dark" name="pan" placeholder="Aadhar number" maxlength="12" pattern="\d{12}" required>
									</div>
								</div>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		buyer_pan,buyer_mail,buyer_username,buyer_password) 
		values ('$name','$phonenumber','$address','$pan',
