                            ...
                            <div class="card-body">
                                ...
                                <form name="my-form" action="InsertProduct.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_title" placeholder="Enter Product title" pattern="[A-Za-z]+" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" id="full_name" class="form-control" name="product_stock" placeholder="Enter Product Stock" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="phone_number" class="form-control" name="product_type" placeholder="Example . potato" pattern="[A-Za-z]+" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" id="nid_number" class="form-control" name="product_price" placeholder="Enter Product price" required>
                                        </div>
                                    </div>
    ...
    if (isset($_SESSION['phonenumber'])) {
        ...
        $insert_product = "insert into products (farmer_fk,product_title, product_cat, 
                                ...
                                values ('$id','$product_title','$product_cat','$product_type','$product_image','$product_stock',
                                        '$product_price','$product_delivery')";
