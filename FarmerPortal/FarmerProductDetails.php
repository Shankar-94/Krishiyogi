     ...
     <nav class="navbar navbar-expand-xl ">
          ...
          <div class=" flex-row-reverse right ">
              ...
              <!-- <div class="dropdown p-2 settings ">
                    <button class="btn text-success" style="margin-top:-20px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <?php echo "<a href='logout.php' class='btn text-success' style='padding-right:-20px;'>Logout</a>";?>
                    </button>
