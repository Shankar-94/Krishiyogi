...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse right ">
            ...
            <?php echo "<a href='../BuyerPortal2/logout.php' class='btn text-success ' style='padding-right:-20px;'>Logout</a>";?>
                <!--<button class="btn text-success" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        //echo "<a href='../BuyerPortal2/logout.php' class='dropdown-item ' style='padding-right:-20px;'>Logout</a>";
                    } else {
